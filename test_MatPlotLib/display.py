...
class Display():
    ...
    def __init__(self, labels):
        ...
        self.df = [pd.DataFrame()] * frame_number
        self.y_min = [int_max_value] * frame_number
        self.y_max = [- int_max_value] * frame_number
        self.range_min = [0] * frame_number
        self.range_max = [0] * frame_number
        self.visible = [[]] * frame_number
        self.color_choice = [[]] * frame_number
        self.chxbox = [0] * frame_number
    ...
    def _add_check_box(self):
        for i in range(self.frame_number):
            ...
            [rec.set_width(0.1) for rec in self.chxbox[i].rectangles]
            [(line1.set_linewidth(0), line2.set_linewidth(0)) for (line1, line2) in self.chxbox[i].lines]
...
class DisplayDataManager():
    ...
    def __init__(self, labels):
        ...
        for i in range(frame_number):
            frame_index.append([])
            frame_index[i] = [NaN] * len(labels[i])
    ...
    def add_data(self, abscise, labels, data):
        ...
        for i in range(self.frame_number):
            for label_index in range(len(labels[i])):
                label = labels[i][label_index]
